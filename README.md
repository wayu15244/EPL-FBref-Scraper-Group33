...
## หมายเหตุเรื่อง Cloudflare

**ครั้งแรกที่รัน:** Chrome จะเปิดขึ้นมาและอาจเจอหน้า "Verify you are human" ให้กดยืนยัน 1 ครั้ง

**ครั้งต่อไป:** Cookie จะถูกเก็บไว้ในโปรแกรม ไม่ต้องกดยืนยันอีก

ถ้าติด Cloudflare วนลูปหลายรอบ ให้ปิดโปรแกรมแล้วลองใหม่
